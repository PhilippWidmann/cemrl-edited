analysis_config = dict(
    ...
    path_to_weights='./output/cheetah-stationary-vel/2022_01_28_14_57_08',  # CONFIGURE! path to experiment folder
    save_dir='./output_analysis/cheetah-stationary-vel/2022_01_28_14_57_08',
    ...
    showcase_itr=50,  # CONFIGURE! epoch for which analysis is performed
    util_params=dict(
