analysis_config = dict(
    ...
    path_to_weights="output/cheetah-stationary-dir/2021_11_28_23_06_08",  # CONFIGURE! path to experiment folder
    train_or_showcase='showcase',  # 'showcase' to load trained policy and showcase
    showcase_itr=500,  # CONFIGURE! epoch for which analysis is performed
    util_params=dict(
    ...
    analysis_params=dict(
        ...
        plot_time_encoding=True,  # CONFIGURE! If True: plot the latent task and base task encodings over an episode
