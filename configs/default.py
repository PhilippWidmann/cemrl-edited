...
default_config = dict(
    ...
    algo_params=dict(
        ...
        decoder_time_window=[-30, 0],  # interval of timesteps (relative to the current one) used in the decoder for reconstruction loss. Both endpoints included. -+inf corresponds to beginning/end of the episode
