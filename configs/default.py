...
default_config = dict(
    ...
    util_params=dict(
        base_log_dir='output',#'/data/bing/philipp/output',  # name of output directory
        use_gpu=True,  # set True if GPU available and should be used
        use_multiprocessing=True,  # set True if data collection should be parallelized across CPUs
