...
class HalfCheetahNonStationaryVelocityEnv(NonStationaryGoalVelocityEnv, MujocoEnv, utils.EzPickle):
...
class ObservableGoalVelHalfCheetahNonStationaryVelocityEnv(HalfCheetahNonStationaryVelocityEnv):
    def __init__(self, *args, **kwargs):
        super(ObservableGoalVelHalfCheetahNonStationaryVelocityEnv, self).__init__(*args, **kwargs)
...
class ObservableRewardHalfCheetahNonStationaryVelocityEnv(HalfCheetahNonStationaryVelocityEnv):
    def __init__(self, *args, **kwargs):
        super(ObservableRewardHalfCheetahNonStationaryVelocityEnv, self).__init__(*args, **kwargs)
